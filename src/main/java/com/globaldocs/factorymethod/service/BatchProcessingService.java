...
/**
 * Simulates real-time batch processing, relying on
 * {@link DocumentProcessorFactory#forCountry(Country)} to obtain the concrete
 * creator for the selected country.
 */
